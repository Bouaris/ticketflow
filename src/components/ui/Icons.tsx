...
export function GraphIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6.5 7.5L10.5 16.5" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.5 7.5L13.5 16.5" />
    </svg>
  );
}
